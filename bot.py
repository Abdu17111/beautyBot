...
#     btn3 = types.KeyboardButton('☕🍹 Угощение')          # ← вместо мастеров
...
# # Новое меню угощения (отдельные кнопки)
...
#     elif text == '☕🍹 Угощение':                    # ← новая кнопка
#         bot.send_message(
#             message.chat.id,
#             "🎁 <b>Угощение для наших любимых гостей</b>\n\n"
#             "Выберите, что хотите попробовать 👇",
#             reply_markup=drinks_menu_markup()
#         )
