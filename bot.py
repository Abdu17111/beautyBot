    ...
    if call.data == 'back_to_main':
        ...
        if call.data == 'cat_nails':
            text = (
                ...
                "<b>— Маникюр —</b>\n"
                "• Детский маникюр (до 10 лет) — 800 ₽\n"
                "• Маникюр без покрытия — 1 400 ₽\n"
                "• Мужской маникюр — 1 500 ₽\n"
                "• Маникюр у топ мастера — 1 700 ₽\n"
                "• Маникюр с покрытием Bandi/IQ — 2 500 ₽\n"
                "• Маникюр с покрытием Luxio — 2 500 ₽\n"
                "• Комплекс Bandi/IQ (снятие+маникюр+покрытие) — 2 800 ₽\n"
                "• Комплекс Luxio (снятие+маникюр+покрытие) — 2 800 ₽\n"
                "• Маникюр с покрытием у топ мастера — 3 300 ₽\n"
                "• Наращивание ногтей — 6 500 ₽\n\n"
                "<b>— Педикюр —</b>\n"
                "• Детский педикюр (до 10 лет) — 1 500 ₽\n"
                "• Педикюр без покрытия — 2 300 ₽\n"
                "• Smart педикюр — 2 500 ₽\n"
                "• Мужской педикюр — 2 500 ₽\n"
                "• Педикюр у топ мастера — 2 700 ₽\n"
                "• Педикюр классический с гель-лаком — 3 200 ₽\n"
                "• Smart педикюр с гель-лаком — 3 500 ₽\n"
                "• Комплексный педикюр с гель-лаком — 3 500 ₽\n"
                "• Педикюр с покрытием у топ мастера — 3 800 ₽"
            )
        elif call.data == 'cat_brows':
            text = (
                "<b>🌟 Брови и ресницы</b>\n\n"
                "• Депиляция нитью/воск: верхняя губа — 550 ₽\n"
                "• Окрашивание бровей — 1 300 ₽\n"
                "• Окрашивание ресниц (краска) — 1 300 ₽\n"
                "• Коррекция бровей (пинцет, воск) — 1 500 ₽\n"
                "• Депиляция лица нитью/воск — 1 500 ₽\n"
                "• Архитектура бровей — 2 500 ₽\n"
                "• Ламинирование бровей — 3 000 ₽"
            )
        elif call.data == 'cat_hair':
            text = (
                "<b>💇‍♀️ Волосы</b>\n\n"
                "• Мужская стрижка — от 2 000 ₽\n"
                "• Стрижка женская — от 1 500 ₽\n"
                "• Стрижка + укладка — 3 500 ₽\n"
                "• Укладка — от 2 500 ₽\n"
                "• Причёски — от 2 500 ₽\n"
                "• Комплексный уход (стрижка + базовый уход + укладка) — 5 500 ₽\n"
                "• Окрашивание в один тон прикорневое — от 6 000 ₽\n"
                "• Окрашивание в один тон — от 6 500 ₽\n"
                "• Сложное окрашивание Airtouch — от 8 500 ₽"
            )
        elif call.data == 'cat_makeup':
            text = (
                "<b>💄 Макияж</b>\n\n"
                "• Дневной макияж / Every day — 3 500 ₽\n"
                "• Вечерний макияж — 5 000 ₽"
            )
