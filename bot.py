...
def services_categories():
    ...
    markup.add(
        ...
        types.InlineKeyboardButton('☕🍹 Бесплатные напитки', callback_data='cat_drinks')  # ← добавлено
    )
    markup.row(
...
MASTERS = [
    ...
    {
        "name": "Диля",
        "spec": "Мастер маникюра и педикюр. Парикмахер",
        "rating": "★★★★★ 55 отзывов",
...
def callback_handler(call):
    if call.data == 'back_to_main':
        ...
        elif category == 'cat_drinks':   # ← добавлено
            text = (
                "<b>☕🍹 Бесплатные напитки</b>\n\n"
                ...
                "🥛 <b>Молоко на выбор:</b> миндальное • кокосовое • классическое\n\n"
